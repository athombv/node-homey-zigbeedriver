...
const ZigBeeLightDevice = require('./ZigBeeLightDevice');
 ...
 * }
 */
class ZigBeeXYLightDevice extends ZigBeeLightDevice {
  ...
  /**
   * Overrides {@link ZigBeeLightDevice.registerColorCapabilities} to register the color
   * capabilities with a different cluster command.
   * @param {ZCLNode} zclNode
   * @returns {Promise<{transitionTime: (number|number), colorY: number, colorX: number}>}
   */
