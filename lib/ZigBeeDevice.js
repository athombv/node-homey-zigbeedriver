...
class ZigBeeDevice extends Homey.Device {
   ...
   * @param {number} [endpointId=1] The endpoint id to fetch the swBuildId from, defaults to 1.
   * @param {boolean} [skipCache=false] If true, it will skip the cache and always fetch the
   * swBuildId from the device.
   ...
   * @param {number} endpointId The endpoint id to fetch the swBuildId from.
   * @returns {Promise<string>} The swBuildId of the device.
