...
class ZigBeeLightDevice extends ZigBeeDevice {
   ...
   * capability values accordingly. Configuring attribute reporting is left to the app, which also
   * owns the `bindings` in the driver manifest that reporting depends on. Devices that do not
   * report simply never trigger these listeners.
   */
