...
class ZigBeeLightDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    const levelControlCluster = zclNode.endpoints[this.getClusterEndpoint(CLUSTER.LEVEL_CONTROL)]
      .clusters.levelControl;
    const onOffCluster = zclNode.endpoints[this.getClusterEndpoint(CLUSTER.ON_OFF)]
      .clusters.onOff;
    const colorControlCluster = zclNode.endpoints[this.getClusterEndpoint(CLUSTER.COLOR_CONTROL)]
