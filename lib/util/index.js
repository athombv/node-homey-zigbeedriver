 ...
 * resolvePath(foo, 'bar.foobar'); // returns '123'
 */
...
function __(localeKey) {
  ...
  const localeValue = resolvePath(localeFile, localeKey);
 ...
 * @param {Function<Number>|Number} [interval=0] - Function (dynamic retry interval) or Number
